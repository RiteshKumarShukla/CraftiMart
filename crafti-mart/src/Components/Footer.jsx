...
const Footer = () => {
  return (
   ...
   <Box mt={4}  w="100%" h="200px" d="flex" flexDirection={{base:"column",md:"row",lg:"row"}}  >
    <Heading as="h3" fontSize="21px" color="#b2004f" textAlign="center" >Band Of Trust</Heading>
   ...
   >
   <BsShieldCheck style={{margin:"auto", mb:"8px"}} color="#b2004f"  size="50px" />
   <Text textAlign="center" mt={2}  color="#b2004f" fontSize="20px">Great Selection</Text>
   </Box>
   <Box pt="7px" mt="20px"   w="200px" height="120px" 
  
  >
  <TbCurrencyRupee style={{margin:"auto", mb:"8px"}} color="#b2004f"  size="50px" />
  <Text  textAlign="center" mt={2}  color="#b2004f" fontSize="20px">Low Price</Text>
  </Box>   
  
  <Box pt="7px" mt="20px"   w="200px" height="120px" 
  
  >
  <AiOutlineShoppingCart style={{margin:"auto", mb:"8px"}} color="#b2004f"  size="50px" />
  <Text  textAlign="center" mt={2}  color="#b2004f" fontSize="20px">Speedy Delivery</Text>
  </Box> 
...
Easy Returns & Replacement</Link>
          ...
          <Stack align={'flex-start'}>
            <Heading as="h3" color="#b20050" fontSize="16px" mb={3}>About Us</Heading>
    ...
    <Box pr="20px" pl="20px" width="100%" h="100px"  display="flex" flexDirection={{base:"column",md:"row",lg:"row"}} justifyContent="space-between" alignItems="center"  >
      ...
      <HStack spacing={4} >
      <AiFillFacebook color="#b20050"  size="40px" />
      <FaPinterestP color="#b20050"  size="40px" />
      <BsTwitter color="#b20050"  size="40px"/>
      <AiFillGooglePlusSquare color="#b20050"  size="40px"/>
      <AiFillYoutube color="#b20050"  size="40px"/>
      <FaLinkedinIn color="#b20050"  size="40px"/>
      </HStack>
