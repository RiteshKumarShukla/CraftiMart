  ...
  return (
    <>
      ...
      <div className='navbar' >
        ...
        <div>
          <Link to="/">
            <img src="https://appreviewsbusiness.files.wordpress.com/2020/02/craftsvilla-logo-01-1024x683-1.png" alt="logo" />
          </Link>
        </div>
...
<button >Search</button>
        ...
        <Box  >
          ...
          <HStack spacing={5}>
            <IoLocationOutline size={25} color='#b2004f' />
            <IoNotificationsOutline size={25} color='#b2004f' />
            <IoMdHeartEmpty color='red' size={25} />
            <Link to="/cart">
              <Flex>
                <IoCartOutline size={25} color='#b2004f' />
      ...
      <div className='subnav1'>
        ...
        <Menu isOpen={menu3.isOpen}>
          ...
          >
            Fashion {menu3.isOpen ? <ChevronUpIcon /> : <ChevronDownIcon />}
          </MenuButton>
        ...
        <Menu isOpen={menu4.isOpen}>
          ...
          >
            Home Decor {menu4.isOpen ? <ChevronUpIcon /> : <ChevronDownIcon />}
          </MenuButton>
        ...
        <Menu isOpen={menu5.isOpen}>
          ...
          >
            Products Near Me {menu5.isOpen ? <ChevronUpIcon /> : <ChevronDownIcon />}
          </MenuButton>
