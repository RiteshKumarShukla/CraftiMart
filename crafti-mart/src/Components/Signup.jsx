  ...
  return (
    ...
    <>
      ...
      >
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <Image margin="auto" mt={5} borderRadius='full' border="2px solid #f58014" boxSize="120px" src='https://appreviewsbusiness.files.wordpress.com/2020/02/craftsvilla-logo-01-1024x683-1.png' />
          ...
          <DrawerBody textAlign="center" >
            ...
            {isAuthenticated ? <Button mt={3} colorScheme="red" onClick={() => logout({ returnTo: window.location.origin })}>
              Log Out
            </Button> : <Button mt={3} colorScheme="green">Login</Button>}
          </DrawerBody>
